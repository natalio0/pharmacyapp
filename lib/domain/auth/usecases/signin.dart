...
class AdminSigninUseCase implements UseCase<Either, AdminSigninReq> {
  @override
  Future<Either> call({AdminSigninReq? params}) async {
  return sl<AuthRepository>().adminSignin(params!);
  }
}
